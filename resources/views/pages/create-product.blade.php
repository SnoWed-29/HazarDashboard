...
@section('content')
    <div class="p-1">
        <div class="container mx-auto flex justify-center py-1">
            <h1 class="text-2xl font-semibold text-center border-b border-gray-400">Ajouter Un Produit</h1>
        </div>
            ...
            <form action="{{ route('createProduct') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div class="col-span-2">                        
                        ...
                        <input class="block w-full mb-5 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="images" name="images[]" type="file" multiple>
                    </div>
                </div>
                <div class="col-span-2 flex justify-around my-2">
                    <div class="flex items-center space-x-2">
                        <input name="isActive" id="checkbox1" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox1" class="text-sm font-medium text-gray-900 dark:text-gray-300">is Active</label>
                    </div>
                    <div class="flex items-center space-x-2">
                        <input name="inStock" id="checkbox2" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox2" class="text-sm font-medium text-gray-900 dark:text-gray-300">in Stock</label>
                    </div>
                    <div class="flex items-center space-x-2">
                        <input name="isFeatured" id="checkbox3" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="checkbox3" class="text-sm font-medium text-gray-900 dark:text-gray-300">is Featured</label>
                    </div>
                    <div class="flex items-center space-x-2">
                        <input name="onSale" id="checkbox4" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
